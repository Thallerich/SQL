...
select
 ...
 iif (KopfPos='P', iif(left(WaeCode,3) = 'CZK', iif(bruttowert>=0, '+', '-') +
                   right('00000000000000' +
                   rtrim(cast(abs(Bruttowert) as varchar(15))),12),null),
                   null) as betrag,                                                     -- Brutto-Betrag
 iif (KopfPos='P', iif(left(WaeCode,3) = 'CZK', iif(MWStBetrag<=0, '+', '-') +
                   right('00000000000000' +
 ...
 iif (KopfPos='P', iif(GegenKonto IN ('602300', '602301', '602302', '602303', '602304', '602305', '602306', '602307', '602401', '602402', '602406', '602403', '602404', '602405', '602406', '602407', '648300'), 77, iif(MWStSatz = 0 AND GegenKonto <> '648100', 7, iif(GegenKonto = '648100', 99, 1))), null) AS steuercode,
 iif (KopfPos='P',
