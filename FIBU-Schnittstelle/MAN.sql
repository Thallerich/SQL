-- Achtung! Dieses SQl unterscheidet sich von den anderen im Feld 'koabteilung' !!
--------------------------------------------------------------------
-- Firma: Wozabal Management GmbH
...
select
 ...
 iif (KopfPos='P', null,
     iif(ProduktionFibuNr <> '0000', right(ProduktionFiBuNr,2),'')) as koabteilung,  -- Produktionsstandort
