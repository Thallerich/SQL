CREATE OR ALTER VIEW [sapbw].[UMLAUF_ALL_orig]
AS
...
WITH U AS (
  SELECT _U.Datum,
	...
	GROUP BY _U.Datum,K.KdNr,V.VsaNr,_U.KdArtiID,A.ArtikelNr,M.IsoCode, AG.Groesse, K.ID, VW.ID,FW.ID,VW.IsoCode,FW.IsoCode
),
VB AS (
