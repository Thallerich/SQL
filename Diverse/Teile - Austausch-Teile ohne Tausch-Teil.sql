...
SELECT Firma.SuchCode AS Firma, Kunden.KdNr, Kunden.SuchCode AS Kunde, Vsa.VsaNr, Vsa.Bez AS Vsa, Traeger.Traeger, Traeger.Vorname, Traeger.Nachname, Artikel.ArtikelNr, Artikel.ArtikelBez AS Artikelbezeichnung, ArtGroe.Groesse AS Größe, EinzHist.Barcode, Teilestatus.StatusBez AS [Status Teil], EinzHist.AbmeldDat AS [Abmelde-Datum], EinzHist.AusdienstDat AS [Außerdienststellungs-Datum], __EinzHistNachfolgeEinzHist.AustauschScanDateTime AS [Zeitpunkt Austausch-Scan], __EinzHistNachfolgeEinzHist.StopAuftragZeitpunkt AS [Zeitpunkt Teil-Abmeldung]
