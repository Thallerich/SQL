...
SELECT App = 
  CASE MdeDevices.Art
    ...
    WHEN N'G' THEN N'Android Eckhardt'
    ...
    WHEN N'L' THEN N'Android Vivantex'
    WHEN N'M' THEN N'Android Garment Inventory'
    WHEN N'N' THEN N'AdvanTex UHF Service Driver App'
    WHEN N'O' THEN N'AdvanTex Pool Inventory'
    WHEN N'P' THEN N'AdvanTex Dispatch'
    WHEN N'U' THEN N'UHF (FTP)'
