...
/* +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ */
/* ++ Fehlende Datensätze nachtragen                                                                                            ++ */
/* +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ */
...
DELETE FROM RPoKonto WHERE KontenID = -1;
...
WHERE RPoType.ID > 0
  ...
  AND NOT EXISTS (
    SELECT r.*
    FROM RPoKonto r
    WHERE r.BereichID = Bereich.ID
      AND r.RPoTypeID = RPoType.ID
      AND r.BrancheID = -1
      AND r.FirmaID = Firmen.ID
      AND r.KdGfID = -1
      AND r.MWStID = MwSt.ID
      AND r.Art = N'B'
      AND r.ArtGruID = -1
  );
