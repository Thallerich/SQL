...
SELECT [Preislisten-Nummer], Preisliste, [Preislisten-Bezeichnung], [1] AS [A-Kunden], [2] AS [B-Kunden], [3] AS [C-Kunden]
FROM (
  SELECT Kunden.KdNr AS [Preislisten-Nummer], Kunden.Name1 AS [Preisliste], Kunden.Name2 AS [Preislisten-Bezeichnung], PrListABCKunden.ABC, PrListABCKunden.Anzahl
  FROM Kunden
