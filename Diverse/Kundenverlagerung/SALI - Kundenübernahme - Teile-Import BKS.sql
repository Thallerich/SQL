...
DECLARE @ImportFile nvarchar(200) = N'\\atenadvantex01\AdvanTex\Temp\2019-05-09_10001781_WaidhofenYbbsDCS.xlsx';  -- Pfad zum Excel-File mit den Teile-Daten. Muss für den SQL-Server-Prozess zugreifbar sein, daher am Besten unter \\atenadvantex01\advantex\temp\ ablegen.
...
SET @XLSXImportSQL = N'SELECT CAST(KDNR as int) AS KdNr, ' +
  ...
  N'CAST(Chipcode AS nvarchar(33)) AS Chipcode ' +
