SELECT Kunden.KdNr, Kunden.SuchCode AS Kunde, Kunden.Debitor, Artikel.ArtikelNr, Artikel.ArtikelBez AS Artikelbezeichnung, SUM(RechPo.Menge) AS [verrechnete Menge], SUM(RechPo.GPreis) AS Umsatz
FROM RechPo
...
WHERE RechPo.KsSt = N'2800'
  ...
  AND RechKo.RechDat BETWEEN N'2018-04-01' AND N'2018-09-30'
