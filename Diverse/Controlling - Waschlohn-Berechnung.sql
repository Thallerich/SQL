...
SELECT LsKo.VsaID, LsPo.KdArtiID, KdBer.BereichID, Bereich.BereichBez AS Produktbereich, Kunden.KdNr, Kunden.Debitor, KdGf.KurzBez AS SGF, Artikel.ArtikelNr, Artikel.ArtikelBez, SUM(LsPo.Menge) AS Liefermenge, Standort.SuchCode AS Produzent, Standort.FibuNr
INTO #LMenge
...
WHERE LsKo.Datum BETWEEN N'2018-04-01' AND N'2018-04-30'
  ...
  AND Artikel.ID > 0
  AND KdGf.KurzBez <> N'ÖS'
GROUP BY LsKo.VsaID, LsPo.KdArtiID, KdBer.BereichID, Bereich.BereichBez, Kunden.KdNr, Kunden.Debitor, KdGf.KurzBez, Artikel.ArtikelNr, Artikel.ArtikelBez, Standort.SuchCode, Standort.FibuNr;
