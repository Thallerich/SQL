...
JOIN Salesianer.dbo._IT95093 ON _IT95093.Kdnr = Kunden.KdNr AND _IT95093.Trägernr = Traeger.Traeger AND _IT95093.ArtikelNr = Artikel.ArtikelNr AND _IT95093.VarianteAlt = KdArti.Variante AND _IT95093.VarianteNeu = NewKdArti.Variante
WHERE EinzHist.[Status] IN ('A', 'C', 'E', 'G', 'I', 'K', 'L', 'LM', 'M', 'N', 'O', 'Q', 'S')
