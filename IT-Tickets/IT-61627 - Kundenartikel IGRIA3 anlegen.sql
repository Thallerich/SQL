...
SELECT N'A' AS [Status], Kunden.ID AS KundenID, Artikel.ID AS ArtikelID, KdBer.BereichID, CAST(190 AS money) AS Waschpreis, Artikel.LiefArtID, Artikel.WaschPrgID, Artikel.MaxWaschen, @UserID AS AnlageUserID_, @UserID AS UserID_
FROM Kunden
CROSS JOIN Artikel
