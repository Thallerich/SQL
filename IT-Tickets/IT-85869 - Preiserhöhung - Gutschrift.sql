...
BEGIN TRY
  BEGIN TRANSACTION;
    ...
    SELECT #Customer.NewRechKoID,
      ...
      RechPo.Sonderpreis,
      RechPo.RabattProz,
      ROUND(CAST(CAST((RechPo.EPreis / 100 * #Customer.Prozentsatz) * RechPo.Menge * -1 AS money) / CAST(100 AS numeric(18, 4)) * RechPo.RabattProz AS money), 2) AS Rabatt,
      ROUND(CAST((RechPo.EPreis / 100 * #Customer.Prozentsatz) * RechPo.Menge * -1 AS money), 2) AS GPreis,
      ROUND(CAST((RechPo.EPreisVertWae / 100 * #Customer.Prozentsatz) * RechPo.Menge * -1 AS money), 2) AS GPreisVertWae,
