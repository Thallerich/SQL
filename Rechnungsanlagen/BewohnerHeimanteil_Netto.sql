...
SELECT Abteil.Abteilung, Abteil.Bez AS KoStBez, Abteil.ID AS KoStID,
Traeger.Nachname, Traeger.Vorname, Traeger.Traeger, Traeger.PersNr AS ZimmerNr,
BewAbr.ServiceProz, KdBer.RabattWasch, BewKdAr.ProzTraeger,
LsPo.ID, LsPo.Menge * LsPo.EPreis * (1 - (KdBer.RabattWasch/100)) AS PosSumme, LsPo.Menge * LsPo.EPreis * (1 - (KdBer.RabattWasch/100)) * ProzTraeger/100 AS AntBew, LsPo.Menge * LsPo.EPreis * (1 - (KdBer.RabattWasch/100)) * (1 - (ProzTraeger/100)) AS AntHeim,
KdBer.BereichID
INTO #TmpLsPoSum
FROM LsPo, LsKo, RechPo, RechKo, Abteil, Traeger, BewAbr, KdBer, KdArti
