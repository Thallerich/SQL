...
/* ++ Version 2.0                                                                                                               ++ */
/* ++                                                                                                                           ++ */
/* ++ Author: Stefan Thaller - 2018-08-07                                                                                       ++ */
/* +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ */
...
GROUP BY LPS.Jahr, LPS.Monat, LPS.RechNr, LPS.Kostenstelle, LPS.KostenstelleBez, LPS.KostenstelleID, LPS.Nachname, LPS.Vorname, LPS.ZimmerNr, LPS.TraegerNr, LPS.RabattBearbeitung, LPS.ServiceProzent
