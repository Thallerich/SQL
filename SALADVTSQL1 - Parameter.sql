...
BEGIN
  ...
  BEGIN TRANSACTION;
    ...
    UPDATE Salesianer.dbo.Settings
      SET [ValueMemo] = N'\\SALADVTAPP1.salres.com\AdvanTex\Data\WebDB_Test\'
      WHERE [Parameter] = N'WEB_EXPORT_UPLOAD_PATH';

    UPDATE Salesianer.dbo.Settings
      SET [ValueMemo] = N'\\SALADVTAPP1.salres.com\AdvanTex\Data\Logos\Salesianer_LogoReleasetest.bmp'
      WHERE [Parameter] = N'LOGO1_PATH_UND_DATEINAME';

    UPDATE Salesianer.dbo.Settings
      SET [ValueMemo] = N'\\SALADVTAPP1.salres.com\AdvanTex\Data\UHFInventur\Testmandant\'
      WHERE [Parameter] = N'INVENTUR_UHF2_PATH';
      
    UPDATE Salesianer.dbo.Settings
      SET [ValueMemo] = N'\\SALADVTAPP1.salres.com\AdvanTex\Data\UHFInventur\Testmandant\Archiv\'
    ...
    UPDATE Salesianer.dbo.Settings
      SET [ValueMemo] = N'\\SALADVTAPP1.salres.com\AdvanTex\Data\Export\Inventurliste\Inventurliste.csv'
    ...
    UPDATE Salesianer.dbo.Settings
      SET [ValueMemo] = N'\\SALADVTAPP1.salres.com\AdvanTex\Data\EDI\EDI_Test\'
      WHERE [Parameter] = N'PATH_EOFFICE';
    
    UPDATE Salesianer.dbo.Settings
      SET [ValueMemo] = N'\\SALADVTAPP1.salres.com\AdvanTex\Data\EDI\BMD_Test\'
    ...
    UPDATE Salesianer.dbo.Settings
      SET ValueMemo = N'\\SALADVTAPP1.salres.com\AdvanTex\Data\Dms\Document\'
      WHERE Parameter = N'PATH_DMS_DOCUMENT';

    UPDATE Salesianer.dbo.Settings
      SET ValueMemo = N'\\SALADVTAPP1.salres.com\AdvanTex\Data\Dms\'
      WHERE Parameter = N'PATH_DMS_MASTERS';

    UPDATE Salesianer.dbo.Settings
      SET ValueMemo = N'\\SALADVTAPP1.salres.com\AdvanTex\Data\email\'
      WHERE Parameter = N'TEMP_ANHANG_PATH';

    UPDATE Salesianer.dbo.Settings
      SET ValueMemo = N'\\SALADVTAPP1.salres.com\AdvanTex\Data\Regina\'
    ...
    UPDATE Salesianer.dbo.Settings
      SET ValueMemo = N'\\SALADVTAPP1.salres.com\AdvanTex\Data\easybackup\'
      WHERE Parameter = N'INVENTUR_FTP_BACKUP_PATH';

    UPDATE Salesianer.dbo.Settings
      SET ValueMemo = N'\\SALADVTAPP1.salres.com\AdvanTex\Data\PflegeBackUp\'
      WHERE Parameter = N'OPETIBCIMPORT_BACKUP_PATH';

    UPDATE Salesianer.dbo.Settings
      SET ValueMemo = N'\\SALADVTAPP1.salres.com\AdvanTex\Data\Rechnungsarchiv\'
      WHERE Parameter = N'PATH_RECHARCH';

    UPDATE Salesianer.dbo.Settings
      SET ValueMemo = N'\\SALADVTAPP1.salres.com\AdvanTex\Data\Mandant\Salesianer\'
      WHERE Parameter = N'DATA_PATH_MANDANT';

    UPDATE Salesianer.dbo.Rentomat 
      SET ExportFile1 = N'\\SALADVTAPP1.salres.com\DCS\Test\'
    ...
    UPDATE Salesianer.dbo.ExpDef
      SET ExportFileName = REPLACE(ExpDef.ExportFileName, N'salshdsvm09_681.salres.com\advpapp_file\', N'\\SALADVTAPP1.salres.com\')
      WHERE ExportFileName LIKE N'\\salshdsvm09_681.salres.com\advpapp_file\%'

    UPDATE Salesianer.dbo.ExpDef
      SET BackupFolder = REPLACE(ExpDef.ExportFileName, N'salshdsvm09_681.salres.com\advpapp_file\', N'\\SALADVTAPP1.salres.com\')
      WHERE BackupFolder LIKE N'%salshdsvm09_681.salres.com\advpapp_file\%';

    UPDATE Salesianer.dbo.RKoOut
      SET ArchivePath = N'\\SALADVTAPP1.salres.com\AdvanTex\Export\Rechnungen_Testmandant\'
      WHERE ArchivePath IS NOT NULL;

    UPDATE Salesianer.dbo.RKoOut
      SET VersandPath = N'\\SALADVTAPP1.salres.com\AdvanTex\Export\Rechnungen_Testmandant\'
    ...
    UPDATE Salesianer.dbo.Settings
      SET ValueMemo = N'\\SALADVTAPP1.salres.com\AdvanTex\Data\SSL\Salesianer_Wildcard_aktuell.crt'
      WHERE Parameter = N'LIVE_SSL_CERT_FILE';

    UPDATE Salesianer.dbo.Settings
      SET ValueMemo = N'\\SALADVTAPP1.salres.com\AdvanTex\Data\SSL\Salesianer_Wildcard_aktuell.key'
