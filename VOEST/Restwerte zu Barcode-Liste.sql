...
SELECT Kunden.kdNr, Vsa.VsaNr, Vsa.Bez AS [VSA-Bezeichnung], Schrank.SchrankNr AS Schrank, TraeFach.Fach, Traeger.Nachname, Traeger.Vorname, Artikel.ArtikelNr, Teile.Barcode, Teilestatus.StatusBez AS Teilestatus, TeileRestwert.RestwertInfo AS Restwert
FROM Teile
