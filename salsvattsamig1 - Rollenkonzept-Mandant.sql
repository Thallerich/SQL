...
RESTORE DATABASE Salesianer_Rollenkonzept
  FROM DISK = N'\\10.10.203.16\mssql_backup\_temp\Salesianer.bak'
  WITH RECOVERY, REPLACE, STATS = 10,
    MOVE N'Salesianer' TO N'D:\SQL Server\UserDB\Salesianer_Rollenkonzept.mdf',
    MOVE N'Salesianer_Log' TO N'D:\SQL Server\TransactionLog\Salesianer_Rollenkonzept_Log.ldf';

GO

ALTER DATABASE Salesianer_Rollenkonzept SET RECOVERY SIMPLE;
GO

ALTER DATABASE Salesianer_Rollenkonzept SET COMPATIBILITY_LEVEL = 150;
GO

USE Salesianer_Rollenkonzept;
GO
...
DBCC SHRINKFILE (N'Salesianer', 100);
GO

DBCC SHRINKFILE (N'Salesianer_log', 10240);
GO