...
SELECT Artikel.ID AS ArtikelID,
  ...
  IIF(VaterVsa.ID IS NULL OR VaterVsa.KundenID != RechKo.KundenID, Vsa.ID, VaterVsa.ID) AS VsaID,
  IIF(VaterVsa.ID IS NULL OR VaterVsa.KundenID != RechKo.KundenID, Vsa.VsaNr, VaterVsa.VsaNr) AS VsaNr,
  IIF(VaterVsa.ID IS NULL OR VaterVsa.KundenID != RechKo.KundenID, Vsa.Bez, VaterVsa.Bez) AS VsaBez,
  IIF(VaterVsa.ID IS NULL OR VaterVsa.KundenID != RechKo.KundenID, Vsa.GebaeudeBez, VaterVsa.GebaeudeBez) AS Abteilung,
  IIF(VaterVsa.ID IS NULL OR VaterVsa.KundenID != RechKo.KundenID, Vsa.Name2, VaterVsa.Name2) AS Bereich,
...
GROUP BY Artikel.ID,
  ...
  Kunden.KdNr,
  Kunden.SuchCode,
  IIF(VaterVsa.ID IS NULL OR VaterVsa.KundenID != RechKo.KundenID, Vsa.ID, VaterVsa.ID),
  IIF(VaterVsa.ID IS NULL OR VaterVsa.KundenID != RechKo.KundenID, Vsa.VsaNr, VaterVsa.VsaNr) ,
  IIF(VaterVsa.ID IS NULL OR VaterVsa.KundenID != RechKo.KundenID, Vsa.Bez, VaterVsa.Bez) ,
  IIF(VaterVsa.ID IS NULL OR VaterVsa.KundenID != RechKo.KundenID, Vsa.GebaeudeBez, VaterVsa.GebaeudeBez),
  IIF(VaterVsa.ID IS NULL OR VaterVsa.KundenID != RechKo.KundenID, Vsa.Name2, VaterVsa.Name2),
  Abteil.ID,
  Abteil.Abteilung,
  Abteil.Bez,
  Traeger.Traeger,
...
INSERT INTO #TmpVOESTRechnung (ArtikelID, BereichID, TraegerID, RechPoID, RechNr, RechDat, KdNr, Kunde, VsaID, VsaNr, VsaBez, Abteilung, Bereich, AbteilID, Kostenstelle, Kostenstellenbezeichnung, ArtikelNr, Variante, Abrechnungswoche, Einzelpreis, Menge, Kosten, Art, Poolentnahme)
SELECT Artikel.ID AS ArtikelID,
  KdBer.BereichID,
...
INSERT INTO #TmpVOESTRechnung (ArtikelID, BereichID, TraegerID, RechPoID, RechNr, RechDat, KdNr, Kunde, VsaID,VsaNr, VsaBez, Abteilung, Bereich, AbteilID, Kostenstelle, Kostenstellenbezeichnung, TraegerNr, PersNr, Nachname, Vorname, ArtikelNr, Größe, Variante, Abrechnungswoche, Einzelpreis, Menge, Kosten, Art, Poolentnahme)
SELECT Artikel.ID AS ArtikelID,
  KdBer.BereichID,
  Traeger.ID AS TraegerID,
  RechPo.ID AS RechPoID,
