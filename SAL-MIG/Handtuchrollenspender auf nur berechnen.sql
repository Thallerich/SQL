...
WHERE Artikel.ArtikelNr IN (N'H100', N'H105', N'H105Z', N'H108', N'H108Z', N'H110', N'H100W', N'A7182A', N'H096', N'H097', N'H098', N'H099', N'H099W', N'H105W', N'H108W', N'H110W', N'H115W', N'096W', N'H097W', N'H098W', N'30904A', N'30904C', N'30904D', N'A5500')
  AND JahrLief.Jahr >= 2020
  AND JahrLief.Lieferwochen <> N'BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB'
  AND Kunden.StandortID IN (SELECT ID FROM Standort WHERE Suchcode IN (N'SAWR'));