...
JOIN sys.indexes ON  indexes.object_id = indexstats.object_id AND indexes.index_id = indexstats.index_id
...
-- 30 is an arbitrary decision point at which to switch between reorganizing and rebuilding.  
        ...
        PRINT CONVERT(char(10), GETDATE(), 114) + N' - Executing: '+ @command;  
        EXEC (@command);  
        PRINT CONVERT(char(10), GETDATE(), 114) + N' - done';
        PRINT N'';
    END;  
