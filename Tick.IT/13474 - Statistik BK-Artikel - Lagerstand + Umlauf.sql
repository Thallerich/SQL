...
SELECT Artikel.ArtikelNr, Status.Bez AS Artikelstatus, Artikel.ArtikelBez$LAN$ AS Artikelbezeichnung, ProdGru.Bez AS Sortiment, ArtGroe.Groesse, GroePo.Folge, ArtGroe.Umlauf AS Umlaufmenge, 0 AS [Bestand Neuware], 0 AS [Bestand Gebraucht], ArtGroe.ID AS ArtGroeID
INTO #TmpResult
