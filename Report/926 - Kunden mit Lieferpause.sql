...
SELECT Standort.Bez AS Haupstandort, Kunden.KdNr, Kunden.SuchCode AS Kunde, Vsa.ID AS VsaID, Vsa.VsaNr, Vsa.SuchCode AS [Vsa-Stichwort], Vsa.Bez AS [Vsa-Bezeichnung], WegGrund.WeggrundBez$LAN$ AS [Lieferpausen-Grund], VsaPause.VonDatum AS [Lieferpause von], VsaPause.BisDatum AS [Lieferpause bis], VsaPause.VonWoche AS [Lieferpause ab KW], VsaPause.BisWoche AS [Lieferpause bis KW]
FROM Vsa
