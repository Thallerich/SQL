SELECT Kunden.KdNr, Kunden.SuchCode AS Kunde, Bereich.BereichBez$LAN$ AS Kundenbereich, Vertrag.Nr AS [Vertrag Nr.], Vertrag.Bez AS Vertragsbezeichung, Vertrag.Status
FROM KdBer
