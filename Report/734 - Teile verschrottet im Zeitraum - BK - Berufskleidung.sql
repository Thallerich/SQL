...
LEFT JOIN (
  SELECT TeilSoFa.EinzHistID, TeilSoFa.SoFaArt, TeilSoFa.RechPoID, TeilSoFa.[Status], TeilSoFa.OhneBerechGrund, TeilSoFa.RwArtID
  FROM TeilSoFa
  GROUP BY TeilSoFa.EinzHistID, TeilSoFa.SoFaArt, TeilSoFa.RechPoID, TeilSoFa.[Status], TeilSoFa.OhneBerechGrund, TeilSoFa.RwArtID
) TeilSoFa ON TeilSoFa.EinzHistID = EinzHist.ID AND TeilSoFa.SoFaArt = N'R' AND (TeilSoFa.RechPoID > 0 OR (TeilSoFa.Status IN (N'L', N'P') AND TeilSoFa.OhneBerechGrund = 0))
