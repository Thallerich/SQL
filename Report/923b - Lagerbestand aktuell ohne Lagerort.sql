...
LEFT JOIN Bestellt ON Bestand.LagerArtID = Bestellt.LagerArtID AND Bestand.ArtGroeID = Bestellt.ArtGroeID
LEFT JOIN Entnahmen ON Bestand.ID = Entnahmen.BestandID
