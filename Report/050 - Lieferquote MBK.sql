...
WHERE Vsa.KundenID = Kunden.ID
  ...
  AND Touren.Wochentag = CONVERT(char(1), IIF(DATEPART(dw, GETDATE()) - 1 = 0, 6, DATEPART(dw, GETDATE()) - 1)) --CONVERT(IIF(dbo.DayOfWeek(GETDATE()) - 1 = 0, 7, dbo.DayOfWeek(GETDATE()) - 1), SQL_CHAR)
