...
GROUP BY Kunden.Debitor, Kunden.KdNr, Kunden.SuchCode, Abteil.Abteilung, Abteil.Bez, Bereich.Bereich, ArtGru.Gruppe, Artikel.ArtikelNr, Artikel.ArtikelBez$LAN$, KdArti.Variante, KdArti.WaschPreis, KdArti.LeasingPreis, RechPo.EPreis, Liefermenge.Liefermenge, RechKo.Art, FORMAT(RechKo.RechDat, N'yyyy.MM', N'de-AT');