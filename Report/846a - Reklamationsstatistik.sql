...
GROUP BY Standort.Bez, Artikel.ArtikelNr, Artikel.ArtikelBez$LAN$, KdArti.Variante, KdArti.WaschPreis, KdGf.KurzBez, Kunden.KdNr, Kunden.SuchCode, Holding.Holding, Branche.BrancheBez$LAN$, KdArti.ID;
...
MERGE INTO #TmpResult846a USING (
  ...
  WHERE Kunden.ID = Vsa.KundenID
    ...
    AND Artikel.ArtGruID NOT IN (26136, 26137, 26154, 26158) --keine Eigenwäsche
  GROUP BY Standort.Bez, Artikel.ArtikelNr, Artikel.ArtikelBez$LAN$, KdArti.Variante, KdArti.WaschPreis, KdGf.KurzBez, Kunden.KdNr, Kunden.SuchCode, Holding.Holding, Branche.BrancheBez$LAN$, KdArti.ID
) AS Reklamationsmenge (Datumsbereich, Standort, Artikelnummer, Artikelbezeichnung, Variante, Reklamationsmenge, Liefermenge, Stückpreis, Geschäftsbereich, KdNr, Kunde, Holding, Branche, KdArtiID)
ON #TmpResult846a.KdArtiID = Reklamationsmenge.KdArtiID
WHEN MATCHED THEN
...
WHEN NOT MATCHED THEN
  INSERT (Datumsbereich, Standort, Artikelnummer, Artikelbezeichnung, Variante, Reklamationsmenge, Liefermenge, Stückpreis, Geschäftsbereich, KdNr, Kunde, Holding, Branche, KdArtiID)
  VALUES (Reklamationsmenge.Datumsbereich, Reklamationsmenge.Standort, Reklamationsmenge.Artikelnummer, Reklamationsmenge.Artikelbezeichnung, Reklamationsmenge.Variante, Reklamationsmenge.Reklamationsmenge, Reklamationsmenge.Liefermenge, Reklamationsmenge.Stückpreis, Reklamationsmenge.Geschäftsbereich, Reklamationsmenge.KdNr, Reklamationsmenge.Kunde, Reklamationsmenge.Holding, Reklamationsmenge.Branche, Reklamationsmenge.KdArtiID);
