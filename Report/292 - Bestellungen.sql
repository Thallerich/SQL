...
GROUP BY BKo.Datum, BKo.BestNr, Bestellstatus.StatusBez, Lief.LiefNr, Lief.Name1, Lagerstandort.Bez, LagerArt.LagerartBez$LAN$, Artikel.ArtikelNr, Artikel.ArtikelBez$LAN$, Bereich.BereichBez$LAN$, BPo.Einzelpreis, BKo.MemoIntern
