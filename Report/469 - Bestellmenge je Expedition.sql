...
GROUP BY ServType.Bez, AnfKo.Lieferdatum, Artikel.ArtikelNr, Artikel.ArtikelBez$LAN$, IIF($5$ = 1, Kunden.KdNr, NULL), IIF($5$ = 1, Kunden.SuchCode, NULL), IIF($5$ = 1, ABC.ABC, NULL), IIF($6$ = 1, Vsa.Bez, NULL), Artikel.StueckGewicht
