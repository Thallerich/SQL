...
UPDATE Settings SET ValueMemo = N'https://kunden.salesianer.com/' WHERE Parameter = N'INTERNET_HTTP_URL';
UPDATE Settings SET ValueMemo = N'https://kunden.salesianer.com/upload_20201020/index.php' WHERE Parameter = N'INTERNET_IMPORT_PHP';
UPDATE Settings SET ValueMemo = N'https://kunden.salesianer.com/upload_20201020/index_http.php' WHERE Parameter = N'INTERNET_IMPORT_PHP_HTTP';
UPDATE Settings SET ValueMemo = N'https://kunden.salesianer.com/upload_20201020/update.php' WHERE Parameter = N'INTERNET_IMPORT_PHP2';
UPDATE Settings SET ValueMemo = N'https://kunden.salesianer.com/output_20201020/' WHERE Parameter = N'INTERNET_OUTPUT';
